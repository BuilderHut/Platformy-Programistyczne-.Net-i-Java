...
import { DrivingLicenseDeleteDialog } from './driving-license-delete-dialog';

describe('DrivingLicense Management Delete Component', () => {
  let comp: DrivingLicenseDeleteDialog;
  let fixture: ComponentFixture<DrivingLicenseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DrivingLicenseDeleteDialog);
