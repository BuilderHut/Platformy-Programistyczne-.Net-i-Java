...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mycompany.carrental.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mycompany.carrental.security.DomainUserDetailsService", "createSpringSecurityUser");
