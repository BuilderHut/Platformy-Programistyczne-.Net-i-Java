...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '43fd1065-1b51-4ec4-9c4a-198f6798a98c' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'carrentalApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('357d5f0e-395a-4d05-a17c-8e615727f65c');
      cy.get(`[data-cy="name"]`).should('have.value', '357d5f0e-395a-4d05-a17c-8e615727f65c');
