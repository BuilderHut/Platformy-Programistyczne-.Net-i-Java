...
describe('Category e2e test', () => {
  ...
  let username: string;
  let password: string;
  const categorySample = { name: 'urgently extremely' };
  ...
  describe('Category page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Category').should('not.contain', 'carrentalApp.category.home.title');
    });
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('as recklessly noxious');
      cy.get(`[data-cy="name"]`).should('have.value', 'as recklessly noxious');

      cy.get(`[data-cy="description"]`).type('terribly');
      cy.get(`[data-cy="description"]`).should('have.value', 'terribly');
