...
namespace Lab4Blazor
{
    public partial class MLModel
    {
        ...
        {
            [LoadColumn(0)]
            [ColumnName(@"polarity of tweet�")]
            public float Polarity_of_tweet_ { get; set; }

            [LoadColumn(1)]
            [ColumnName(@"id of the tweet")]
            public float Id_of_the_tweet { get; set; }

            [LoadColumn(2)]
            [ColumnName(@"date of the tweet")]
            public string Date_of_the_tweet { get; set; }
            ...
            [LoadColumn(5)]
            [ColumnName(@"text of the tweet�")]
            public string Text_of_the_tweet_ { get; set; }
        ...
        {
            [ColumnName(@"polarity of tweet�")]
            public uint Polarity_of_tweet_ { get; set; }

            [ColumnName(@"id of the tweet")]
            public float Id_of_the_tweet { get; set; }

            [ColumnName(@"date of the tweet")]
            public float[] Date_of_the_tweet { get; set; }
            ...
            [ColumnName(@"text of the tweet�")]
            public float[] Text_of_the_tweet_ { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("polarity of tweet�");
            if (labelColumn == null)
            {
                throw new Exception("polarity of tweet� column not found. Make sure the name searched for matches the name in the schema.");
            }
